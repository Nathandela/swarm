...
// TestPlayReleaseIdentityIsV01322Code34 pins the two values Google Play uses to
...
// versionCode 33).
func TestPlayReleaseIdentityIsV01322Code34(t *testing.T) {
	build := readFileOrFail(t, filepath.Join(appModule(t), "build.gradle.kts"), "Play release identity")

	assertSingleGradleAssignment(t, build, "versionCode", `34`)
	assertSingleGradleAssignment(t, build, "versionName", `"0.13.22"`)
}
