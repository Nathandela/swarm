...
- [Phone refit playbook](specifications/phone-refit-playbook.md) — owner-directed 2026-08-27, the contract for seven waves: pinned frame, sending works, one button, Slate palette (ADR-020), rewritten words, one-line tool rows, the other screens. Per wave: files allowed, tests first, gates, done-when. Interactive mock: https://claude.ai/code/artifact/90c122aa-eff2-4e47-a4f1-6d9e8757ba99
