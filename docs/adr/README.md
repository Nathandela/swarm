...
| [010](ADR-010-inter-session-orchestration.md) | Inter-session orchestration — agent-initiated spawn, handoff, observation, and steering via local CLI verbs | Accepted (amended 2026-08-07, 2026-08-18, 2026-08-26, 2026-09-02 twice) | 2026-08-07 |
