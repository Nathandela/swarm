...
| Clock skew | **surface distinctly** beyond +/-30 s. Rejection is the DAEMON's, at its own wider bands (below) — the phone does not refuse its own commands. | PB-TIME-1 |
