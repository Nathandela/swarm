...
| 8 | Attached; Ctrl+q (ADR-006; was Ctrl+\ pre-v0.2); back to general view, session continues | `skeleton/serve_test.go:TestSkeleton_DetachLeavesSessionAndReattachSucceeds` |
