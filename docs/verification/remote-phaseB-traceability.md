...
**15 of 146 requirements are DERIVED.** The rest have never had a fence broken on
...
| PB-PUSH-0 | S12 | shipped | not derived | `docs/verification/remote-phaseB-s12-evidence.md` |
| PB-PUSH-1 | S12 | shipped | not derived | `docs/verification/remote-phaseB-s12-evidence.md` |
| PB-PUSH-2 | S12 | shipped | not derived | `docs/verification/remote-phaseB-s12-evidence.md` |
| PB-PUSH-3 | S12 | **NOT MET** | not derived | the fence asserts SIZE; the requirement asks for a SCHEMA. The presence sweep emits 78 RANDOM bytes, and the relay holds no key it could seal a real envelope with -- by two-tier design. A provider that PARSES rather than measures still separates a sweep from a wake, because a genuine wake's envelope header is cleartext. The project's OWN disclosure document says so in as many words -- 'Still open: the sweep is separable by SHAPE, just not by SIZE' -- while this row read shipped. Mutation: a plaintext payload leaves every PB-PUSH-3 test passing (ADR-007 B96) |
| PB-PUSH-4 | S17 | shipped | not derived | `docs/verification/remote-phaseB-s17-evidence.md` |
| PB-PUSH-5 | S12 | shipped | not derived | `docs/verification/remote-phaseB-s12-evidence.md` |
| PB-PUSH-6 | S12 | shipped | not derived | `docs/verification/remote-phaseB-s12-evidence.md` |
| PB-PUSH-7 | S12 | shipped | not derived | `docs/verification/remote-phaseB-s12-evidence.md` |
| PB-PUSH-8 | S12 | shipped | not derived | `docs/verification/remote-phaseB-s12-evidence.md` |
| PB-PUSH-9 | S17 | shipped | not derived | `docs/verification/remote-phaseB-s17-evidence.md` |
| PB-PUSH-10 | S12 | shipped | not derived | `docs/verification/remote-phaseB-s12-evidence.md` |
...
| PB-SEC-3 | S18 | shipped | not derived | `docs/verification/remote-phaseB-s18-evidence.md` |
| PB-SEC-4 | S18 | shipped | not derived | `docs/verification/remote-phaseB-s18-evidence.md` |
| PB-SEC-5 | S18 | shipped | not derived | `docs/verification/remote-phaseB-s18-evidence.md` |
| PB-SEC-6 | S18 | shipped | not derived | `docs/verification/remote-phaseB-s18-evidence.md` |
| PB-SEC-7 | S18 | shipped | not derived | `docs/verification/remote-phaseB-s18-evidence.md` |
| PB-SEC-8 | S18 | shipped | not derived | `docs/verification/remote-phaseB-s18-evidence.md` |
| PB-SEC-10 | S15 | shipped | not derived | `docs/verification/remote-phaseB-s15-evidence.md` |
| PB-SEC-11 | S18 | shipped | not derived | `docs/verification/remote-phaseB-s18-evidence.md` |
| PB-SEC-12 | S18 | shipped | not derived | `docs/verification/remote-phaseB-s18-evidence.md` |
| PB-SEC-13 | S18 | shipped | not derived | `docs/verification/remote-phaseB-s18-evidence.md` |
| PB-SEC-14 | S18 | shipped | not derived | `docs/verification/remote-phaseB-s18-evidence.md` |
